...
text = Text(root, height= 45, width= 100)
...
def find():
	...
	if True : 
		...
		while 1:
			...
			idx = text.search(s, idx, stopindex= END,nocase= False); print(idx)
			if not idx: break
			
			#last index sum of current index and
			#length of text
			lastidx = '%s+%dchar' % (idx, len(s)); print(lastidx)
